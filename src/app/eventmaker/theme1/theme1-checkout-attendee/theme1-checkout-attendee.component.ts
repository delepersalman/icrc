...
@Component({
  selector: 'theme1-checkout-attendee',
  templateUrl: './theme1-checkout-attendee.component.html',
  styleUrls: ['./theme1-checkout-attendee.component.scss']
})
export class Theme1CheckoutAttendeeComponent implements OnInit {
