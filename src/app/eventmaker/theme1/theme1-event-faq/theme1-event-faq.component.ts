...
@Component({
  selector: 'theme1-event-faq',
  templateUrl: './theme1-event-faq.component.html',
  styleUrls: ['./theme1-event-faq.component.scss']
})
export class Theme1EventFaqComponent implements OnInit {
