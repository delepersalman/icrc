...
@Component({
  selector: 'theme1-event-contactus',
  templateUrl: './theme1-event-contactus.component.html',
  styleUrls: ['./theme1-event-contactus.component.scss']
})
export class Theme1EventContactusComponent implements OnInit {
  @Input() eventId;
