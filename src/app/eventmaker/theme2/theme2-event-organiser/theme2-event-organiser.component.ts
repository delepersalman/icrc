...
import { EventDescriptionModel, EventmakerSectionModel, EventWebsiteModel, ngStyleModel, SectionPropertyModel } from 'src/app/shared/models/event-maker/event-maker-model';
...
@Component({
  selector: 'theme2-event-organiser',
  templateUrl: './theme2-event-organiser.component.html',
  styleUrls: ['./theme2-event-organiser.component.scss']
})
export class Theme2EventOrganiserComponent implements OnInit {
