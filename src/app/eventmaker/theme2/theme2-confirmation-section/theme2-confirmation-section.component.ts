...
@Component({
  selector: 'theme2-confirmation-section',
  templateUrl: './theme2-confirmation-section.component.html',
  styleUrls: ['./theme2-confirmation-section.component.scss']
})
export class Theme2ConfirmationSectionComponent implements OnInit {
